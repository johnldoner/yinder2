...
/*
        $scope.chat.push('New Item ' + Math.floor(Math.random() * 1000) + 4);
        $scope.chat.push('New Item ' + Math.floor(Math.random() * 1000) + 4);
        $scope.chat.push('New Item ' + Math.floor(Math.random() * 1000) + 4);
*/
...
.controller("LoginCtrl", ["$scope", "$firebase", "Auth", function($scope, $firebase, Auth) {
   ...
   .controller("LoginCtrl", ["$scope", "$firebase", "Auth","ionicPopup",function($scope, $firebase,$timeout, $q, $ionicPopup, Auth) {
  //add the popup
  */
  .controller("LoginCtrl", ["$scope", "$firebase", "$timeout", "$q","$ionicPopup","Auth",function($scope, $firebase,$timeout, $q, $ionicPopup, Auth) {
